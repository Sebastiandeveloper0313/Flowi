  ...
  return (
    <LegalPage title="Terms of Service" updated="July 2, 2026">
      <LegalSection heading="1. Who we are">
        <p>
          Flowy ("Flowy", "we", "us") is an AI marketing service operated from Sweden. These Terms
          of Service ("Terms") are a binding agreement between you and Flowy and govern your use of
          the Flowy website, application, and related services (together, the "Service"). By
          creating an account or using the Service, you agree to these Terms. If you use Flowy on
          behalf of a company, you confirm you have authority to bind that company, and "you" means
          that company.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="2. The Service">
        <p>
          Flowy is an AI marketing employee. You describe marketing work in plain language and Flowy
          performs it: finding relevant conversations and leads, drafting and publishing posts and
          replies, working with your email, and running recurring agents on a schedule. Flowy acts
          through accounts you connect (such as Gmail, Reddit, LinkedIn, Facebook, and Slack) and
          reports results back to you in the app, by email, or in Slack.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="4. Connected accounts and authorization">
        <p>
          When you connect a third-party account, you authorize Flowy to access and act through that
          account on your behalf, within the permissions you grant during the OAuth flow. You can
          revoke a connection at any time in the app or with the third-party provider.
        </p>
        <p>
          Actions Flowy takes through your connected accounts (posts, replies, emails, messages) are
          made in your name and are your responsibility. Flowy provides approval controls: in Ask
          mode, outward-facing actions are queued for your explicit approval before anything is sent
          or published. If you enable Auto mode, you instruct Flowy to act without asking first, and
          you accept responsibility for those actions as if you had approved each one.
        </p>
      </LegalSection>

      <LegalSection heading="5. AI-generated content">
        <p>
          Flowy uses large language models to analyze information and generate content. AI output
      ...
      <LegalSection heading="7. Trial, subscription, and billing">
        <p>
          Flowy offers one paid plan (Pro) with a 3-day free trial for new customers. A payment
      ...
      <LegalSection heading="8. Your content and data">
        <p>
          You retain all rights to the content you provide and to the marketing content Flowy
