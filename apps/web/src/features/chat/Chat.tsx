...
// often" instead of accepting Entrives' guess. "once" maps to no schedule.
...
function ProposalCard({ proposal }: { proposal: AgentProposal }) {
  ...
  // Editable draft, seeded from Entrives' proposal.
  ...
  const composer = (
    <div className="bg-card focus-within:border-primary/50 focus-within:ring-primary/10 mx-auto w-full max-w-2xl rounded-[1.7rem] border p-4 shadow-[0_24px_60px_-32px_rgba(16,48,120,0.4)] transition focus-within:ring-4">
      ...
      <Textarea
        ...
        onPaste={onPaste}
        rows={1}
        placeholder="Tell Entrives what to do…  e.g. “every day at noon, 3 slides on menswear trends”"
      ...
      <div className="flex min-h-[82vh] flex-col items-center justify-center px-2">
        <div className="w-full max-w-2xl">
          <h2 className="text-center text-3xl font-bold tracking-tight sm:text-4xl">
            What should Entrives take care of?
          </h2>
          <p className="text-muted-foreground mx-auto mt-3 mb-8 max-w-2xl text-center">
            Ask a question, or describe a recurring job and Entrives runs it on schedule.
          </p>
          {composer}
        </div>
        {lightbox}
    ...
    <div className="flex h-screen flex-col">
      ...
      <div className="px-2 pt-2 pb-6">
        ...
        <p className="text-muted-foreground mt-2 text-center text-xs">
          ...
          Entrives can answer, or set up agents that run on their own.
        </p>
      </div>
      {lightbox}
    </div>
