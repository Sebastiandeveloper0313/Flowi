...
const MODES: { value: AutonomyMode; label: string; hint: string }[] = [
  ...
  { value: "auto", label: "Auto", hint: "Senable carries them out on its own" },
];

/** Composer control to set how much Senable does on its own (ask vs auto). */
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          title="How much Senable does on its own"
        >
