...
export const activity: ActivityItem[] = [
  {
    ...
    at: "Today, 11:00 AM",
    status: "success",
    summary: "Triaged 23 tickets, filed ZET-311, flagged 1 urgent.",
    channel: "dashboard",
  },
  {
    id: "a2",
    agentId: "ag_trends",
    agentName: "Menswear trend slides",
    at: "Today, 12:00 PM",
    status: "success",
    summary: "Posted 3-slide trend deck.",
    channel: "slack",
  },
  {
    id: "a3",
    ...
    at: "Today, 8:00 AM",
    status: "success",
    summary: "$48.2k booked (+14%). 3 deals at risk.",
    channel: "discord",
  },
  {
    id: "a4",
  ...
  },
  {
    ...
    at: "Today, 10:00 AM",
    status: "success",
    summary: "Triaged 11 tickets, drafted 9 replies.",
    channel: "dashboard",
  },
  {
    id: "a6",
  ...
  },
  {
    ...
    at: "Last Fri, 4:00 PM",
    status: "success",
    summary: "Audited $8.2k spend, flagged 2 campaigns.",
    channel: "whatsapp",
  },
  {
    id: "a8",
...
export const integrations: Integration[] = [
  {
    ...
    connected: true,
    account: "Acme Inc",
    scopes: ["Read charges", "Read balance", "Read customers"],
  },
  {
    key: "hubspot",
    name: "HubSpot",
  ...
  },
  {
    ...
    category: "Files",
    connected: true,
    account: "founder@acme.com",
    scopes: ["Read files", "Create files"],
  },
  {
    key: "discord",
    name: "Discord",
...
export const recentChats: RecentChat[] = [
  {
    id: "chat_competitors",
    title: "Track our competitors daily",
    at: "Today",
    agentId: "ag_competitors",
  },
  ...
  {
    id: "chat_adspend",
    title: "Audit ad spend every Friday",
    at: "Yesterday",
    agentId: "ag_adspend",
  },
...
export const memory: MemorySection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Autonomy",
        value: "Auto-run low-risk recaps; ask before anything that spends money.",
      },
    ],
  },
];
