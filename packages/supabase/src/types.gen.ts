...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      delete_workspace: { Args: { p_team_id: string }; Returns: undefined }
      email_digest_candidates: {
        Args: never
        Returns: {
          email: string
          full_name: string
      ...
      sentrive_dispatch_due_tasks: { Args: never; Returns: undefined }
      ...
      webhook_delete_connection: {
        Args: { p_team_id: string }
        Returns: undefined
      }
      webhook_store_connection: {
        Args: { p_secret: string; p_team_id: string; p_url: string }
        Returns: undefined
      }
      ...
      wordpress_delete_connection: {
        Args: { p_team_id: string }
        Returns: undefined
      }
      wordpress_store_connection: {
        Args: {
